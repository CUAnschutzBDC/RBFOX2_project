Inclusion_Up <- read.table("Dropbox/Manuscripts/RBFOX2 Manuscript/Data/GSE183247_rMATS_output_v4.0.2/inclusionexons.upstream.kmercounts.txt", skip = 1, col.names = c("kmer", "i_up_kmer","i_up_total"))
...
Exclusion_Up <- read.table("Dropbox/Manuscripts/RBFOX2 Manuscript/Data/GSE183247_rMATS_output_v4.0.2/exclusionexons.upstream.kmercounts.txt", skip = 1, col.names = c("kmer", "e_up_kmer","e_up_total"))
...
Insense_Up <- read.table("Dropbox/Manuscripts/RBFOX2 Manuscript/Data/GSE183247_rMATS_output_v4.0.2/insensitives.upstream.kmercounts.txt", skip = 1, col.names = c("kmer", "insensitive_up_kmer","insensitive_up_total"))
Insense_Down <- read.table("Dropbox/Manuscripts/RBFOX2 Manuscript/Data/GSE183247_rMATS_output_v4.0.2/insensitives.upstream.kmercounts.txt", skip = 1, col.names = c("kmer", "insensitive_down_kmer","insensitive_down_total"))
