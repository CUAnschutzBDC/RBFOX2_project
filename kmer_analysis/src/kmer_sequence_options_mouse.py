...
parser.add_argument("-g", "--genome", dest = "genomefasta",
    ...
    default = "/beevol/home/mossnico/GEO_Datasets/ref/star/mouse/Grm38/GRCm38.primary_assembly.genome.fa",
    action = "store",
    metavar = "\b")
...
inclusion_coordinates = os.path.join(options.input_dir, 'inclusionexon.coordinates.txt')
exclusion_coordinates = os.path.join(options.input_dir, 'exclusionexon.coordinates.txt')
insensitive_coordinates = os.path.join(options.input_dir, 'insensitive.coordinates.txt')
